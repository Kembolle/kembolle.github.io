...
(function() {
     ...
     * 
     */
    function Cones(controller, originalParams) {
    ...
    p.loop = function(data) {
        ...
        for (var i = 1; i <= 5; i++) {
            ctx.drawImage(buffer, dX1, dY1, dW1, dH1, sX1, sY1, sW1, sH1);
            ctx.drawImage(buffer, dX2, dY2, dW2, dH2, sX2, sY2, sW2, sH2);
    ...
    wimpy.extension.eq.renderers.Cones = Cones;
