...
(function() {
     ...
     * 
     */
    function Fabric(controller, originalParams) {
    ...
    p.loop = function(data) {
        ...
        var sX1 = bob * (0.5 - this._avgData);
        var sY1 = bob;
        var sW1 = WIDTH - bob;
        var sH1 = HEIGHT - (0.5 - this._avgData);
        ...
        for (var i = 0; i < bufferLength; i++) {
            ...
            ctx.fillStyle = color;
            ctx.fillRect(x, startPos - HALF_HEIGHT * this._avgData * val, unitSize, specSize);
            x += unitSize;
    ...
    wimpy.extension.eq.renderers.Fabric = Fabric;
